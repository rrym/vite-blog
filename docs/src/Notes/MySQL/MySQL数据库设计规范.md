...
title: "MySQL数据库设计规范"
outline: deep
desc: "MySQL数据库设计规范（仅供参考）！"
tags: "MySQL"
updateTime: "2024-04-25 14:53"
---
...
1. 规范背景与目的
2. 设计规范2.1 数据库设计2.1.1 库名2.1.2 表结构2.1.3 列数据类型优化2.1.4 索引设计2.1.5 分库分表、分区表2.1.6 字符集2.1.7 程序DAO层设计建议2.1.8 一个规范的建表语句示例2.2 SQL编写2.2.1 DML语句2.2.2 多表连接2.2.3 事务2.2.4 排序和分组2.2.5 线上禁止使用的SQL语句
...
5. 【强制】禁止联表更新语句，如`update t1,t2 where [t1.id](http://t1.id/)=[t2.id](http://t2.id/)…`。